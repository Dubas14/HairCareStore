...
const benefits = [
  ...
  },
  {
    ...
    title: '100% оригінал',
    description: 'Вся продукція від офіційних дистрибʼюторів з сертифікатами якості.',
  },
  {
    id: 3,
    icon: 'delivery' as const,
    title: 'Швидка доставка',
    description: 'Відправляємо Новою Поштою та Укрпоштою по всій Україні. Зазвичай 1-3 дні.',
  },
  {
    id: 4,
    icon: 'bonus' as const,
